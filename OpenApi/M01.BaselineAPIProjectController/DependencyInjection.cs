...
public static class DependencyInjection
{
    ...
    public static IServiceCollection AddApiDocumentation(this  IServiceCollection services)
    {
        ...
        foreach(var version in versions)
        {
            ...
            {
                //options.ShouldInclude = (apiDescription) => apiDescription.GroupName == version;
                // Version Configruation (MetaData)
                options.AddDocumentTransformer<OpenApi.Transformers.VersionTransformer>();

                // Security Configuration 
                options.AddDocumentTransformer<OpenApi.Transformers.BearerSecuritySchemeDocumentTransformer>();
                options.AddOperationTransformer<OpenApi.Transformers.BearerSecuritySchemeOperationTransformer>();
            });
